...
// FIX: Corrected import path for VideoAspectRatio type.
...
const VideoGeneratorPanel: React.FC = () => {
    ...
    return (
        <form onSubmit={handleGenerate} className="w-full bg-gray-800/50 rounded-lg p-4 flex flex-col gap-4 animate-fade-in">
            ...
            <button
                type="submit"
                className="w-full mt-2 bg-gradient-to-br from-purple-600 to-indigo-500 text-white font-bold py-4 px-6 rounded-lg transition-all disabled:from-gray-600 disabled:cursor-not-allowed flex items-center justify-center gap-2"
