...
/**
 * @description Gerencia o estado e os manipuladores de eventos para as funcionalidades de pan e zoom.
 * @returns {object} Um objeto contendo o estado de pan e zoom, e as ações para manipulá-los.
 */
export const usePanAndZoom = () => {
  ...
  // Desativa o modo 'pan' automaticamente se o zoom for redefinido para o mínimo.
  useEffect(() => {
    if (zoom <= 1) {
  ...
  return { zoom, setZoom, panOffset, setPanOffset, isPanModeActive, setIsPanModeActive, handleWheel, handlePanStart, resetZoomAndPan, isCurrentlyPanning };
};
